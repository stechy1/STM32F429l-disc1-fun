...
/* CDC Endpoints parameters: you can fine tune these values depending on the needed baudrates and performance. */
 ...
 #define CDC_IN_FRAME_INTERVAL          0   /*40 Number of micro-frames between IN transfers */
 #define APP_RX_DATA_SIZE               16384 /*10280 2048 Total size of IN buffer: 
...
/*ZJ 2507* @defgroup USB_HID_Class_Layer_Parameter
  * @{
  */ 
